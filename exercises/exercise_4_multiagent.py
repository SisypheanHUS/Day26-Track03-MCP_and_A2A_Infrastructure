...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về luật bảo vệ dữ liệu cá nhân và GDPR. Phân tích khía cạnh privacy trong câu hỏi:

Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR (phạt đến 4% doanh thu toàn cầu hoặc EUR 20M), CCPA (phạt đến $7,500/vi phạm),
quyền của chủ thể dữ liệu, nghĩa vụ thông báo rò rỉ dữ liệu (72 giờ theo GDPR),
trách nhiệm của Data Controller và Data Processor."""
